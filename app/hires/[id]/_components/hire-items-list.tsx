          ...
          <li key={hi.id} className="flex items-center justify-between gap-3 px-4 py-3">
            <div className="min-w-0">
              <p className="text-sm font-medium text-white truncate">
                {hi.item ? itemDisplayName(hi.item) : 'Unknown item'}
              </p>
            ...
            {status === 'draft' && (
              <button
                ...
                disabled={busy !== null}
                aria-label={`Remove ${hi.item ? itemDisplayName(hi.item) : 'item'}`}
            ...
            {status === 'active' && !hi.checked_in_at && (
              <button
                ...
                disabled={busy !== null}
                aria-label={`Check in ${hi.item ? itemDisplayName(hi.item) : 'item'}`}
